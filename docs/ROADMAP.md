...
| 8   | **Focus & heatmap**             | Pomodoro timer that fills the study heatmap and streak                                                                                                                                              | —                                                                                         | 🟡 25-min focus timer on Home logs minutes per course; 18-week heatmap + streak. Needs migration 0007                                                                                                  |
| 9   | **Polish**                      | Phone layout pass, a week of real daily use + fixes                                                                                                                                                 | Feedback                                                                                  | Ongoing                                                                                                                               |

**Now: Phase 8 — focus timer + study heatmap (first slice shipped; needs migration 0007).**
