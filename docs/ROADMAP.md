...
| 7   | **Grades**                      | Current grade per course, what-if / "need X on final"                                                                                                                                               | —                                                                                         | 🟡 Canvas's current grade per course (Home Grades block, course page, assistant) and a "need X on the final" calculator. Needs migration 0006                                                                                                   |
...
**Now: Phase 7 — grades + what-if (first slice shipped; needs migration 0006).**
