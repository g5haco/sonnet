...
| 6   | **Materials + syllabus import** | Upload hub (PDF, Word, PowerPoint, photos, notes, links); AI extracts deadlines, exams, class times and grade weights for review; exam study guides from your materials                             | A real syllabus                                                                           | 🟡 Uploads, text from PDFs, photos and scans (vision model), the AI reads a course's materials, **syllabus import with review** (syllabi stay in the AI's memory). Next: exam study guides, context-aware chat shortcuts |
