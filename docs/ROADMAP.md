...
| 4 | **Calendar** | Day / week / month views with class times, due dates and exams; semester timeline with a heavy-week heat map; gooey view switch; Google Calendar feed | Your class schedule | 🔨 In progress: class times, day/week/month views, semester heat map done; Google Calendar feed next |
