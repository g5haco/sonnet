...
| 2   | **App shell**                   | Animated sidebar (Home, Calendar, Courses, Chat), gooey Create menu, floating Settings window (semester, Canvas, sign out), AI chat panel UI with shortcut chips and voice dictation, metal send button | —                                                                                         | ✅ Done                                                                                                                               |
...
| 6   | **Materials + syllabus import** | Upload hub (PDF, Word, PowerPoint, photos, notes, links); AI extracts deadlines, exams, class times and grade weights for review; exam study guides from your materials                             | A real syllabus                                                                           | 🟡 Floating uploader + per-course materials (files, links, notes) built. AI reading them + syllabus import next |
| 7   | **Grades**                      | Current grade per course, what-if / "need X on final"                                                                                                                                               | —                                                                                         | 🟡 Canvas now syncs scores; the Grades block still shows a placeholder                                                                                                   |
