...
| 3 | **AI assistant** | Answers from Claude that know your courses, assignments, exams and class times; thinking-orb states; later it can add and edit items for you | OpenRouter API key | 🔄 Answers live; add/edit tools next |
| 4 | **Calendar** | Day / week / month views with class times, due dates and exams; semester timeline with a heavy-week heat map; gooey view switch; Google Calendar feed | Your class schedule | ⏳ |
